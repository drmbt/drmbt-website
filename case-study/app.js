    ...
    const headerHtml = `
      <header class="site-header">
        ...
        <nav class="site-nav" aria-label="Main">
          ...
          <a href="https://github.com/drmbt" target="_blank" rel="noopener">GitHub</a>
          <a href="https://instagram.com/drmbt" target="_blank" rel="noopener">Instagram</a>
          <a href="mailto:vincent@drmbt.com">Contact</a>
        </nav>
      </header>
    `;
